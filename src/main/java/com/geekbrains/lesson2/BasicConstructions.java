...
public class BasicConstructions {
    ...
    public static boolean method5(int year) {
        ...
        if( year%4 == 0 ){                  // выделили все возможные високосные
            if ( year%100 != 0) {
                return true;                // все Високосные кроме 100-ых
            } else if ( year%400 == 0) {
                return true;                // из 100-ых разрешили только 400-ые Високосные
            }else {
                return false;               // все НЕвисокосные 100-ые, но уже без 400-х
            }
        }else {
            return false;                   // все НЕвисокосные и не 100-ые
        }
    }
