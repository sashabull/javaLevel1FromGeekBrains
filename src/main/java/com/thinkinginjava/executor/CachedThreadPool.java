...
/**
 * одновременный запуск несколькоих потоков методом executor()
 */
public class CachedThreadPool {
    public static void main(String[] args) {
        ExecutorService exec = Executors.newCachedThreadPool();
        for (int i = 0; i < 5; i++) exec.execute(new RunnableTest());
        exec.shutdown();
        System.out.println("main() waiting stop treads RunnableTest!");
    }
}
/* output console:
поток #0, работа потока (10),
поток #0, работа потока (9),
main() waiting stop treads RunnableTest!
